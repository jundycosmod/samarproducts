...
if(move_uploaded_file($_FILES['uploadedfile']['tmp_name'], $target_path)) {
  ...
  $insertSQL = sprintf("INSERT INTO products (product_code, product_name, product_description, product_type, manufacturer, price, product_picture) VALUES (%s, %s, %s, %s, %s, %s, %s)",
...
?>
  ...
  <table width="200" border="0" align="center">
    <tr>
      <td>Product Name:</td>
      <td><label>
        <input type="text" name="product_name" id="product_name" <?php if (!empty($missing) || (isset($totalRows_Recordset1) && $totalRows_Recordset1!=0)) {
echo 'value="'.htmlentities($_POST['product_name']).'"';
    ...
    <tr>
      <td>Product Code:</td>
      <td><label>
        <input type="text" name="product_code" id="product_code" <?php if (!empty($missing) || (isset($totalRows_Recordset1) && $totalRows_Recordset1!=0)) {
...
echo htmlentities($_POST['product_description']);
    ...
    <tr>
      <td>Price:</td>
      <td><label>
        <input type="text" name="price" id="price" <?php if (!empty($missing) || (isset($totalRows_Recordset1) && $totalRows_Recordset1!=0)) {
