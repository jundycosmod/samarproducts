...
$fullname = mysql_query($query_fullname, $akonsudoy) or die(mysql_error());
$row_fullname = mysql_fetch_assoc($fullname);
$totalRows_fullname = mysql_num_rows($fullname);
...
<br />
          ...
          <div class="clear"></div>
          <div id="footer">
              Created by <a href="#">BS Information Technology 4-A Students of SSU</a>
