...
if ((isset($_GET['id'])) && ($_GET['id'] != "")) {
  $deleteSQL = sprintf("DELETE FROM manufacturers WHERE id=%s",
...
$manufacturer = mysql_query($query_manufacturer, $akonsudoy) or die(mysql_error());
...
<table border="1" align="center">
  ...
  <?php do { ?>
    ...
    <?php } while ($row_manufacturer = mysql_fetch_assoc($manufacturer)); ?>
</table>
</body>
</html>
<?php
