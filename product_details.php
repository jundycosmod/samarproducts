...
$product_details = mysql_query($query_product_details, $akonsudoy) or die(mysql_error());
$row_product_details = mysql_fetch_assoc($product_details);
$totalRows_product_details = mysql_num_rows($product_details);
...
<?php 
	  ...
	  $i++;
	  } while ($row_product_details = mysql_fetch_assoc($product_details)); ?>
    </form>
...
<?php
mysql_free_result($product_details);
?>
