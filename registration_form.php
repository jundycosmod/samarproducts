...
$query_email = mysql_query($query_query_email, $akonsudoy) or die(mysql_error());
$row_query_email = mysql_fetch_assoc($query_email);
$totalRows_query_email = mysql_num_rows($query_email);
unset($missing);
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1") && ($_POST['password1'] != "") && ($_POST['password1'] == $_POST['password2']) && (empty($missing)) && ($totalRows_query_email<1)) {
  $insertSQL = sprintf("INSERT INTO users (email, send, password, fullname, gender, age, pnumber, cnumber, address, city, access_level) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['email'], "text"),
                       GetSQLValueString($_POST['send'], "int"),
                       GetSQLValueString($_POST['password1'], "text"),
                       GetSQLValueString($_POST['fullname'], "text"),
                       GetSQLValueString($_POST['gender'], "text"),
                       GetSQLValueString($_POST['age'], "int"),
                       GetSQLValueString($_POST['pnumber'], "text"),
...
?>
        ...
        <input type="text" name="email" id="email" <?php if (!empty($missing) || ($_POST && ($_POST['password1'] != $_POST['password2'])) || (isset($totalRows_query_email) && $totalRows_query_email!=0) || isset($error_msg)) {
...
No</td>
    ...
    <tr>
      ...
      <div align="left">
        <?php
if (isset($missing) && in_array('password1', $missing)) { ?>
...
?>
        ...
        <input type="password" name="password1" id="password1" <?php if (!empty($missing) || ($_POST && ($_POST['password1'] != $_POST['password2'])) || (isset($totalRows_query_email) && $totalRows_query_email!=0) || isset($error_msg)) {
echo 'value="'.htmlentities($_POST['password1']).'"';
    ...
    <tr>
      ...
      <div align="left">
        <?php
if (isset($missing) && in_array('password2', $missing)) { ?>
            <span class="warning style1">Please confirm your password.</span>
          <?php 
}
?>
          <br />
        <input type="password" name="password2" id="password2" <?php if (!empty($missing) || ($_POST && ($_POST['password1'] != $_POST['password2'])) || (isset($totalRows_query_email) && $totalRows_query_email!=0) || isset($error_msg)) {
echo 'value="'.htmlentities($_POST['password2']).'"';
    ...
    <tr>
      ...
      <div align="left">
        <?php
if (isset($missing) && in_array('fullname', $missing)) { ?>
...
?>
          ...
          <input type="text" name="fullname" id="fullname" <?php if (!empty($missing) || ($_POST && ($_POST['password1'] != $_POST['password2'])) || (isset($totalRows_query_email) && $totalRows_query_email!=0) || isset($error_msg)) {
...
?>
  <br />
  <input type="text" name="age" id="age" <?php if (!empty($missing) || ($_POST && ($_POST['password1'] != $_POST['password2'])) || (isset($totalRows_query_email) && $totalRows_query_email!=0) || isset($error_msg)) {
...
?>
          <br />
          <input type="text" name="pnumber" id="pnumber" <?php if (!empty($missing) || ($_POST && ($_POST['password1'] != $_POST['password2'])) || (isset($totalRows_query_email) && $totalRows_query_email!=0) || isset($error_msg)) {
echo 'value="'.htmlentities($_POST['pnumber']).'"';
    ...
    <tr>
      ...
      <div align="left">
        <?php
if (isset($missing) && in_array('cnumber', $missing)) { ?>
            <span class="warning style1">Please enter your cellphone number.</span>
          <?php 
}
?>
        <br />
          <input type="text" name="cnumber" id="cnumber" <?php if (!empty($missing) || ($_POST && ($_POST['password1'] != $_POST['password2'])) || (isset($totalRows_query_email) && $totalRows_query_email!=0) || isset($error_msg)) {
...
?>
        <br />
        <input type="text" name="address" id="address" /<?php if (!empty($missing) || ($_POST && ($_POST['password1'] != $_POST['password2'])) || (isset($totalRows_query_email) && $totalRows_query_email!=0) || isset($error_msg)) {
...
?>
        <br />
          <input type="text" name="city" id="city" <?php if (!empty($missing) || ($_POST && ($_POST['password1'] != $_POST['password2'])) || (isset($totalRows_query_email) && $totalRows_query_email!=0) || isset($error_msg)) {
