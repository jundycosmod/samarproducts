...
if(move_uploaded_file($_FILES['uploadedfile']['tmp_name'], $target_path)) {
  ...
  $updateSQL = sprintf("UPDATE products SET product_code=%s, product_name=%s, product_description=%s, product_type=%s, manufacturer=%s, price=%s, product_picture=%s WHERE product_id=%s",
