...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
  $updateSQL = sprintf("UPDATE users SET email=%s, send=%s, fullname=%s, gender=%s, age=%s, pnumber=%s, cnumber=%s, address=%s, city=%s, access_level=%s WHERE user_id=%s",
...
$profile = mysql_query($query_profile, $akonsudoy) or die(mysql_error());
